...
import {
    ...
    CheckCircle2, UtensilsCrossed, Smartphone, LogOut, User as UserIcon
} from "lucide-react";
            ...
            <div className="max-w-6xl mx-auto">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="relative">
                            <button
                                ...
                                className="bg-[#111] p-1.5 rounded-2xl border border-white/5 hover:border-[#d4a365]/30 transition-all"
                            >
                                ...
                                {isProfileOpen && (
                                    <>
                                        ...
                                        <motion.div
                                            ...
                                            className="absolute right-0 top-full mt-4 w-60 bg-[#0f0f0f] border border-white/10 rounded-[2rem] p-3 z-50 shadow-2xl backdrop-blur-xl"
                                        >
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-6 mb-12">
                    <div className="flex-grow flex gap-2 overflow-x-auto no-scrollbar pb-2">
                        {["All", "Main Course", "Noodles", "Appetizer", "Dessert", "Drinks"].map(cat => (
                            <button
                                ...
                                className={`px-6 py-2.5 rounded-full text-[9px] font-black uppercase tracking-widest border transition-all whitespace-nowrap ${activeTab === cat ? 'bg-[#d4a365] text-black border-[#d4a365]' : 'bg-[#111] text-gray-500 border-white/5 hover:text-white'
                                    }`}
                            >
                                {cat}
                            </button>
                    ...
                    <div className="relative group">
                        ...
                        <input
                            type="text"
                            placeholder="Зоог хайх..."
                            value={search}
                            onChange={(e) => setSearch(e.target.value)}
                            className="bg-[#111] border border-white/5 rounded-2xl py-3 pl-12 pr-6 text-sm focus:outline-none focus:border-[#d4a365]/50 focus:ring-1 focus:ring-[#d4a365]/50 w-full md:w-64 transition-all"
                        />
                    </div>
                </div>
                        ...
                        <motion.div initial={{ x: "100%" }} animate={{ x: 0 }} exit={{ x: "100%" }} transition={{ type: "spring", damping: 25 }} className="relative w-full max-w-md bg-[#0f0f0f] h-full p-8 flex flex-col shadow-2xl border-l border-white/5">
                            ...
                            <div className="mt-8 pt-8 border-t border-white/5 space-y-6">
                                ...
                                <button
                                    ...
                                    className="w-full bg-[#d4a365] text-black font-black py-5 rounded-[2.5rem] hover:bg-[#f0c080] transition-all flex items-center justify-center gap-3 active:scale-95 disabled:opacity-30 shadow-2xl"
                                >
